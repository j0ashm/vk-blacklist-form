            ...
            <FormControl isRequired>
                ...
                <Box mt="5">
                    ...
                    <RadioGroup name="division">
                        ...
                        <Radio value="Republic Intelligence" onChange={onInputChange}>Republic Intelligence</Radio>
                        <Radio value="Red Guard" onChange={onInputChange}>Red Guard</Radio>
                        <Radio value="501st" onChange={onInputChange}>501st Legion</Radio>
                        <Radio value="Republic Commandos" onChange={onInputChange}>Republic Commandos</Radio>
                        <Radio value="Coruscant Guard" onChange={onInputChange}>Coruscant Guard</Radio>
                        <Radio value="104th Batallion" onChange={onInputChange}>104th Batallion</Radio>
